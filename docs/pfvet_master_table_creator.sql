 ...
 */
 ...
 /* TABLA PRINCIPAL DE GESTION DE ADJUNTOS
 -----------------------------------------
 	id                  
	id_originador  ID DEL ORIGINADOR (MASCOTAS, ARTICULOS, RUBROS, ETC.)
	originador     TIPO DE ORIGINADOR
	contenido      DIRECCION DE ALMACENAMIENTO DEL ADJUNTO
	estado		   ESTADO DEL ADJUNTO
	falta          FECHA DE ALTA DE ESTE REGISTRO
	halta          HORA DE ALTA DE ESTE REGISTRO 
 */
  
 CREATE  TABLE pfvet_adjuntos ( 
	id                   integer  NOT NULL  ,
	id_originador        integer  NOT NULL  ,
	originador           char(25)  NOT NULL  ,
	contenido           text  NOT NULL  ,
	estado			char(25)  NOT NULL  ,
	falta                date    ,
	halta                time    ,
	CONSTRAINT pk_pfvet_adjuntos PRIMARY KEY ( id )
 );